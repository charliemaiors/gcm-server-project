 ...
 */
public class Notification implements Data{
    ...
    public Notification(String title, String body, String icon, String sound, String badge, String tag, String color, String click_action, String body_loc_key, String[] body_loc_args, String[] title_loc_key, String[] title_loc_args) {
        this.title = title;
        this.body = body;
        this.icon = icon;
        this.sound = sound;
